...
# CIFAR100 Class-Incremental Learning
from .MTIL_datasets.cifar100_cil import get_cifar100_cil_datasets
...
def get_dataset(cfg, split, transforms=None):
    ...
    elif cfg.dataset == "CIFAR100_CIL":
        '''
            CIFAR100 Class-Incremental Learning:
            Split CIFAR100 into multiple tasks, each containing a subset of classes.
        '''
        num_tasks = cfg.CIL.num_tasks
        num_classes_per_task = cfg.CIL.num_classes_per_task
        
        # Get all task datasets
        cil_datasets = get_cifar100_cil_datasets(
